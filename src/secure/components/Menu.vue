  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="sidebar-sticky pt-3">
      <ul class="nav flex-column">
        ...
        <li class="nav-item"  v-if="user.canView('users')">
          <a href="#" active-class="active" class="nav-link"><i>Client-under dev</i></a>
        </li>
        <li class="nav-item"  v-if="user.canView('users')">
          <a href="#" active-class="active" class="nav-link"><i>Hours-under dev</i></a>
        </li>
        <li class="nav-item"  v-if="user.canView('users')">
          <a href="#" active-class="active" class="nav-link"><i>Admin-under dev</i></a>
        </li>
        <li class="nav-item"  v-if="user.canView('users')">
          <a href="#" active-class="active" class="nav-link"><i>Sales-under dev</i></a>
        </li>
